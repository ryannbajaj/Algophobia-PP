...
bikerstill = loadAnimation('biker/Biker_run_attack copy 0.png')
...
function setup() {
  ...
  player.addAnimation('still',bikerstill);
  player.addAnimation('playerimg',bikerrun);
   ...
   controlsIMG = createSprite (50, 100, 50, 50);
   howtoplayIMG = createSprite (660, 100, 50,50);
...
//restart.visible = false
  ...
  controlsIMG.addImage(controls);


  
  howtoplayIMG.addImage(howtoplay);
...
if (keyDown("UP_ARROW")){
    player.velocityY = -7
    player.changeAnimation('playerimg',bikerrun)
  }
  }
  ...
  // player.changeAnimation('still',bikerstill);
...
if (gamestate == 1){
 ...
 background("black");
 skull = createSprite (390, 110, 20,20);
 ...
 fill ("white");
 textFont('Arial');
 text('Final Score: '+ score,345 , 330  );(15)
 
 textSize(15)
 fill ("white");
 textFont('Arial');
 text('BEAT IT NEXT TIME!');
 
 



 restart_bt = createSprite(395,230,20,20)
